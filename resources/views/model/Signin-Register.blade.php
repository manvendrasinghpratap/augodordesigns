                        ...
                        <div class="tab-content" id="tab-content-5">
                            ...
                            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                <form method="POST" action="{{ route('register.store') }}" autocomplete="off" id="registration" name="registration">
                                    ...
                                    <x-input-field :labelstatus="false" id="remail" label="Email" type="email" name="remail" value="{{ old('remail') }}" placeholder="{{ __('translation.enter_email') }}" class="form-control lowercase-input" autocomplete="new-email" />

                                    <x-input-field :labelstatus="false" id="rpassword" label="Password" type="password" name="rpassword" placeholder="{{ __('translation.password') }}" autocomplete="new_password" />
