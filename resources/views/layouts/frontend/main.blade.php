                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="banner banner-overlay">
                                <a href="#">
                                    <img src="{{ asset('assets/images/demos/demo-6/banners/banner-1.jpg')}}" alt="Banner">
                                </a>
                        ...
                        <div class="col-sm-6">
                            <div class="banner banner-overlay">
                                <a href="#">
                                    <img src="{{ asset('assets/images/demos/demo-6/banners/banner-2.jpg')}}" alt="Banner">
                                </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-7 text-center">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-6/products/product-5-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{ asset('assets/images/demos/demo-6/products/product-5-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                ...
                <div class="container newsletter">
                    <div class="row">
                        <div class="col-lg-6 banner-overlay-div">
                            <div class="banner banner-overlay">
                                <a href="#">
                                    <img src="{{ asset('assets/images/demos/demo-6/banners/banner-3.jpg')}}" alt="Banner">
                                </a>
                    ...
                    <div class="owl-carousel owl-simple mb-3" data-toggle="owl" 
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/images/demos/demo-6/blog/post-1.jpg')}}" alt="image desc">
                                </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/images/demos/demo-6/blog/post-2.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/images/demos/demo-6/blog/post-3.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
