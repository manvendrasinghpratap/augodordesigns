									...
									<div class="demo-list">
										...
										<div class="demo-item hidden">
											<a href="index-25.html">
												<span class="demo-bg" style="background-image: url('{{ asset('assets/images/menu/demos/25.jpg') }}');"></span>
										...
										<div class="demo-item hidden">
											<a href="index-26.html">
												<span class="demo-bg" style="background-image: url('{{ asset('assets/images/menu/demos/26.jpg') }}');"></span>
										...
										<div class="demo-item hidden">
											<a href="index-27.html">
												<span class="demo-bg" style="background-image: url('{{ asset('assets/images/menu/demos/27.jpg') }}');"></span>
										...
										<div class="demo-item hidden">
											<a href="index-28.html">
												<span class="demo-bg" style="background-image: url('{{ asset('assets/images/menu/demos/28.jpg') }}');"></span>
										...
										<div class="demo-item hidden">
											<a href="index-29.html">
												<span class="demo-bg" style="background-image: url('{{ asset('assets/images/menu/demos/29.jpg') }}');"></span>
										...
										<div class="demo-item hidden">
											<a href="index-30.html">
												<span class="demo-bg" style="background-image: url('{{ asset('assets/images/menu/demos/30.jpg') }}');"></span>
										...
										<div class="demo-item hidden">
											<a href="index-31.html">
												<span class="demo-bg" style="background-image: url('{{ asset('assets/images/menu/demos/31.jpg') }}');"></span>
